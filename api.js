        ...
        if (countryData && typeof countryData === 'object') {
            Object.keys(countryData).forEach(countryKey => {
                ...
                Object.keys(countryVal).forEach(innerKey => {
                    ...
                    Object.keys(providersObject).forEach(providerKey => {
                        ...
                        variants.forEach(v => {
                            ...
                            // 2. Strict enforcement for WhatsApp/wa: Only fetch GOLD rank
                            if (cleanServiceCode === 'whatsapp' || cleanServiceCode === 'wa') {
                                if (String(rawRank).trim().toLowerCase() !== 'gold') {
                                    return; // Skip non-gold entries for WhatsApp
                                }
                            }
                            ...
                            // 3. Custom Service Pricing Rules
                            if (cleanServiceCode === 'whatsapp' || cleanServiceCode === 'wa') {
                ...
                if (allAvailablePrices.length > 0) {
                    ...
                    // Keeps only the two lowest prices (among Gold ranks for WhatsApp)
